    ...
    <div className="flex items-center justify-center min-h-screen bg-[#f1f2f4] px-4 py-8 font-sans">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white shadow-[0_20px_60px_rgba(0,51,90,0.08)] rounded-[2rem] p-7 sm:p-10 border border-slate-100">
          <h1 className="text-2xl font-black text-[#0f172a] mb-1 tracking-tight">Welcome back</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5" noValidate>
            {/* Email */}
            <div>
              <label className="block text-[11px] font-black text-slate-500 uppercase tracking-[0.2em] mb-2" htmlFor="login-email">
                Email Address
              </label>
              <input
                type="email"
            ...
            {/* Password */}
            <div>
              <label className="block text-[11px] font-black text-slate-500 uppercase tracking-[0.2em] mb-2" htmlFor="login-password">
                Password
              </label>
          ...
          <p className="text-center text-sm text-slate-500 mt-7">
            ...
            <Link to="/register" className="text-[#00335a] font-black hover:underline underline-offset-2">
              Sign up
            </Link>
          </p>
        </div>
